...
results_folder = Path("Mini_Project/results_chemotaxis/2D")
...
# gamma_p_real = 8.54e-1  # c_b: reprodução bacteriana
...
# Difusão
D_p_real = 5.0e-5  # Db: difusão da bactéria [cm²/s]
D_l_real = 5.0e-5  # Dn: difusão do neutrófilo [cm²/s]

# Dinâmica da bactéria
gamma_p_real = 1.5e-1  # cb: reprodução bacteriana [1/s]
lambda_lp_real = 1.8  # lambda_nb: fagocitose [cm³/(s.cel)]

# Dinâmica dos neutrófilos
gamma_l_real = 1.0e-1  # gamma_n: recrutamento/permeabilidade capilar
lambda_pl_real = 1.0e-1  # lambda_bn: apoptose induzida
mu_l_real = 2.0e-1  # mu_n: apoptose natural [1/s]

# Concentração de neutrófilos no sangue
Clmax_real = 5.5e-1  # Cn,max

# Sensibilidade quimiotática
chi_real = 1.0e-4  # chi_nb
...
petsc_options = {
    ...
    # Sistema linear de Newton
    "ksp_type": "preonly",
    "pc_type": "lu",
    "pc_factor_mat_solver_type": "mumps",
    # Ative inicialmente para diagnóstico
    # "snes_monitor": None,
...
problem = NonlinearProblem(
    ...
    petsc_options_prefix="pathogen_leukocytes_2D_",
)
